...
//   return (
//     <section>
// {/* <main style={{ background: "linear-gradient(135deg,#fff 0%,#f7ecff 40%,#e6f1ff 100%)", paddingBottom: 60 }}> */}
//     <SectionIntro
  ...
  items={[
    {
      ...
      desc:
        "Handles both front-end and back-end, providing complete solutions. Flexibility and fast iteration across the application.",
    },
    {
      title: "Co-Effective Solutions",
      desc:
        "Fewer resources than separate teams. Scales with robust architecture and integrated systems.",
    },
    {
      title: "Faster Time to Market",
      desc:
        "Rapid delivery for dynamic, scalable, feature-rich web and mobile apps.",
    },
    {
