  ...
  return (
    <section className={styles.page}>
      ...
      <div className={styles.hero}>
        <HeroTitleChip
          imageSrc="/images/services/fullstackdevelopment-hero.png"
      ...
      {/* SECTION 1 (content + image updated) */}
      <SplitFeature
        image="/images/services/image 38.png"
        title="Why you should use full stack Development and how panacea can help you"
        body={'Full stack development provides a complete solution for building modern, scalable, and high-performing applications. It enables seamless integration between the front-end and back-end, ensuring a smooth user experience and efficient data flow. With expertise across multiple technologies, full stack developers can handle every aspect of development — from design to deployment.'}
      ...
      {/* SECTION 2 (content + image updated) */}
      <SplitFeature
      ...
      {/* BENEFITS (content + image updated) */}
      <FeatureList
        ...
        items={[
          {
            ...
            desc:
              "Handles both front-end and back-end, providing complete solutions. Flexibility — easy to adapt and implement changes across the application.",
          },
          {
            title: "Co-Effective Solutions",
            desc:
              "Fewer resources required compared to separate front-end and back-end teams. Supports growth with robust architecture and integrated systems.",
          },
          {
            title: "Faster Time to Market",
            desc:
              "The Full Stack Development market is growing rapidly due to demand for dynamic, scalable, feature-rich web and mobile applications.",
          },
          {
            title: "Enhanced Scalability",
            desc:
              "Efficiently handles increasing workloads and users without compromising performance.",
          },
        ]}
      ...
      {/* CTA + FOOTER (unchanged structure) */}
      <CtaPanel
