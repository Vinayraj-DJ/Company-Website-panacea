  ...
  return (
    <section className={styles.page}>
      ...
      <div className={styles.hero}>
        <HeroTitleChip
          imageSrc="/images/services/media-hero.png"
          alt="Media Queries"
          title={`Media Queries`}
        />
      ...
      <SplitFeature
        image="/images/services/media-what.png"
      ...
      <SplitFeature
        image="/images/services/media-how.png"
      ...
      <FeatureList
        ...
        illustrationSrc="/images/services/media-benefits.png"
