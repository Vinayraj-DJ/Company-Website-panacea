...
const Hypare = () => {
  ...
  {
    title: "Windows Azure",
    image: "/images/services/azure.png",
    description:
  ...
  return (
    ...
    <section className={styles.page}>
      <div className={styles.hero}>
        <HeroTitleChip
          imageSrc="/images/products/HPR.png"
          alt="hpr"
          title={"Hyderabad\nParty Rentals"}
      ...
      <HeroSection
        ...
        imageSrc="/images/products/HPR2.png"
        accent="#4070B1"
      />
       <HeroSection
        ...
        imageSrc="/images/products/HPR3.png"
        accent="#4070B1"
        reverse={true}
      />
      ...
      <HeroSection
        ...
        imageSrc="/images/products/HPR4.png"
        accent="#4070B1"
