...
// // Cloud/DevOps & Testing sub-pages
// import DevOps from "../pages/ServicesPage/CloudDevOpsSection/DevOps/DevOps";
// import AWS from "../pages/ServicesPage/CloudDevOpsSection/AWS/AWS";
// import WindowsAzure from "../pages/ServicesPage/CloudDevOpsSection/WindowsAzure/WindowsAzure";
// import CloudConsulting from "../pages/ServicesPage/CloudDevOpsSection/CloudConsultingServices/CloudConsultingServices";
...
// import SchoolApp from "../pages/ProductsPage/SchoolApp/SchoolApp";
// import FitnessApp from "../pages/ProductsPage/FitnessAPP/FitnessAPP";
// import GamingApp from "../pages/ProductsPage/GamingAPP/GamingAPP";
// import GroceryApp from "../pages/ProductsPage/GroceryDeliveryApp/GroceryDeliveryApp";
// import ECommerceApp from "../pages/ProductsPage/ECommerceApp/ECommerceApp";

// // make sure E-Learning import path matches your real filename
// // (some projects use E-LearningApp/E-LearningApp etc; update if necessary)
...
//         {/* Services sections */}
//         <Route path="/services/application-development" element={<ApplicationDevelopmentSection />} />
//         <Route path="/services/digital-marketing" element={<DigitalMarketingSection />} />
//         <Route path="/services/website-development" element={<WebDevelopmentSection />} />
//         <Route path="/services/mobile-application" element={<MobileAppSection />} />
//         <Route path="/services/website-designing" element={<WebsiteDesigningSection />} />
//         <Route path="/services/cms-ecommerce" element={<CMSEcommerceSection />} />
//         <Route path="/services/clouds-and-devops" element={<CloudDevOpsSection />} />
//         <Route path="/services/testing-automation" element={<TestingAutomationSection />} />

//         {/* Application development sub-pages */}
//         <Route path="/services/application-development/full-stack-development" element={<FullstackDevelopment />} />
//         <Route path="/services/application-development/digital-transformation" element={<DigitalTransformation />} />
//         <Route path="/services/application-development/sales-force-consulting" element={<SalesForceConsulting />} />
//         <Route path="/services/application-development/bi-and-data-analysis" element={<BIDataAnalytics />} />
//         <Route path="/services/application-development/software-development" element={<SoftwareDevelopment />} />
//         <Route path="/services/application-development/custom-application" element={<CustomApplication />} />
//         <Route path="/services/application-development/big-data-services" element={<BigDataServices />} />
//         <Route path="/services/application-development/sap-consulting-services" element={<SapConsulting />} />
...
//         <Route path="/services/digital-marketing/inbound-marketing" element={<InboundMarketing />} />
//         <Route path="/services/digital-marketing/content-marketing" element={<ContentMarketing />} />
//         <Route path="/services/digital-marketing/pay-per-click-ppc" element={<PPCMarketing />} />

//         {/* Web development sub-pages */}
//         <Route path="/services/web-development/php-development" element={<PhpDevelopment />} />
//         <Route path="/services/web-development/node-js-development" element={<NodeDevelopment />} />
//         <Route path="/services/web-development/angular-js-development" element={<AngularDevelopment />} />
//         <Route path="/services/web-development/react-js-development" element={<ReactDevelopment />} />
...
//         {/* Testing/QA & Cloud */}
//         <Route path="/services/testing-automation/quality-engineering" element={<QualityEngineering />} />
//         <Route path="/services/testing-automation/quality-consulting" element={<Qualityconsulting />} />
//         <Route path="/services/testing-automation/quality-assurance" element={<Qualityassurance />} />

//         <Route path="/services/clouds-and-devops/devops" element={<DevOps />} />
//         <Route path="/services/clouds-and-devops/aws" element={<AWS />} />
//         <Route path="/services/clouds-and-devops/windows-azure" element={<WindowsAzure />} />
//         <Route path="/services/clouds-and-devops/cloud-consulting-services" element={<CloudConsulting />} />

//         {/* Website designing */}
//         <Route path="/services/website-designing/media-queries" element={<MediaQueries />} />
//         <Route path="/services/website-designing/flexible-images" element={<FlexibleImages />} />
//         <Route path="/services/website-designing/improve-user-experience" element={<UserExperience />} />
//         <Route path="/services/website-designing/impact-on-seo-ranking" element={<SeoRanking />} />

//         {/* Products */}
//         <Route path="/products/child-care-management" element={<ChildCareManagement />} />
//         <Route path="/products/hyderabad-party-rentals" element={<Hypare />} />
//         <Route path="/products/influencers-app" element={<InfluencersApp />} />
//         <Route path="/products/mutual-funds" element={<MutualFunds />} />
//         <Route path="/products/car-wash-app" element={<BabaCarWash />} />
//         <Route path="/products/omr-customization" element={<OMRSheetCustomization />} />
//         <Route path="/products/ott-app" element={<OTTApp />} />
//         <Route path="/products/ticket-booking-app" element={<TicketBookingApp />} />
//         <Route path="/products/school-app" element={<SchoolApp />} />
//         <Route path="/products/grocery-delivery" element={<GroceryApp />} />
//         <Route path="/products/ecommerce-website" element={<ECommerceApp />} />
//         <Route path="/products/jewellery-website" element={<JewelleryWebsite />} />
//         <Route path="/products/e-learning-app" element={<ELearningApp />} />
//         <Route path="/products/gaming-app" element={<GamingApp />} />
//         <Route path="/products/fitness-app" element={<FitnessApp />} />
