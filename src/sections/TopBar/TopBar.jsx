...
//       setScrolled(y > 10);
//       const toastEl = document.querySelector(`.${styles.toastContainer}`);
//       if (toastEl) {
//         const topbarHeight = topbarRef.current
//           ? topbarRef.current.offsetHeight
//           : 78;
//         toastEl.style.top = `${topbarHeight + 6}px`;
//       }
...
//   // Attach hover listeners to product hover host/panel on desktop and compute floating pos
//   useEffect(() => {
...
//       // Tweak: overlap negative to move the button up into the panel (desktop only)
//       const OVERLAP = -24; // <-- moved up more (change this value to tune)
...
//             mobileSub === "products" ? styles.openMobile : ""
//           }`}
//         >
//           <button
...
//               mobileSub === "products" ? styles.mobilePanelOpen : ""
//             }`}
//           >
...
//         <div
//           className={`${styles.hoverTrigger} ${
//             mobileSub === "services" ? styles.openMobile : ""
//           }`}
//         >
//           <button
//             className={styles.menuItemBtn}
...
//             id="submenu-services"
//             className={`${styles.hoverPanel} ${
//               mobileSub === "services" ? styles.mobilePanelOpen : ""
//             }`}
//           >
//             <div className={styles.megaInner}>
//               <ServiceHoverTopbar />
...
//         <span
//           className={`${styles.menuItem} ${
//             isActive("/aboutuspage") ? styles.active : ""
//           }`}
...
//         <span
//           className={`${styles.menuItem} ${
//             isActive("/spotlight") ? styles.active : ""
//           }`}
...
//             top: floatingTop
//               ? `${floatingTop}px`
//               : (topbarRef.current ? topbarRef.current.offsetHeight + 8 : 86) +
//                 "px",
//             zIndex: 1600,
...
//   const toastTimerRef = useRef(null);
//   const toastRef = useRef(null);      // <— NEW: ref instead of querySelector
//   const topbarRef = useRef(null);
...
//       // Use the ref to position the toast safely (no selector strings)
...
//               {!isMobile() && (
//                 <div className={styles.viewAllRow}>
//                   <button className={styles.viewAllBtn} onClick={() => go("/products")}>
//                     View all products →
//                   </button>
//                 </div>
//               )}
...
//               {!isMobile() && (
//                 <div className={styles.viewAllRow}>
//                   <button className={styles.viewAllBtn} onClick={() => go("/services")}>
//                     View all services →
//                   </button>
//                 </div>
//               )}
...
//             </div>
//             <div className={styles.toastBody}>{toast.message}</div>
//             <button className={styles.toastClose} onClick={hideToast} aria-label="Close">
//               <FiX />
//             </button>
//             <div className={styles.toastTimer} />
//           </div>
...
const TopBar = () => {
  ...
  const toastTimerRef = useRef(null);
  const toastRef = useRef(null);      // <— ref instead of querySelector
  const topbarRef = useRef(null);
  ...
  // NEW: Delegate anchor clicks inside product/services panels to react-router
  useEffect(() => {
    const handleDelegatedNav = (e) => {
    ...
    const prod = document.getElementById('submenu-products');
    const serv = document.getElementById('submenu-services');

    prod?.addEventListener('click', handleDelegatedNav, true);
    serv?.addEventListener('click', handleDelegatedNav, true);

    return () => {
      prod?.removeEventListener('click', handleDelegatedNav, true);
      serv?.removeEventListener('click', handleDelegatedNav, true);
    };
  }, [navigate]);
